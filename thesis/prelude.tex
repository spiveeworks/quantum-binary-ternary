...
\title{QUANTUM COMPUTATION IN MIXED BINARY-TERNARY SYSTEMS} % use all capital letters
\author{Jarvis Carroll} % use mixed upper & lower case
\prevdegrees{B.Sc.} % Used to specify your previous degrees...use mixed upper & lower case
