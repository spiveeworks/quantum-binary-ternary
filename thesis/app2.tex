...
\section{hashmap.h}
\lstset{language=c}
\lstinputlisting[breaklines=true]{../src/hashmap.h}
\clearpage
\section{generator.h}
\lstinputlisting[breaklines=true]{../src/generator.h}
\clearpage
\section{matrix{\_}quadratic.h}
\lstinputlisting[breaklines=true]{../src/matrix_quadratic.h}
\clearpage
\section{matgroup.c}
\lstinputlisting[breaklines=true]{../src/matgroup.c}
\clearpage
\section{permutation.c}
\lstinputlisting[breaklines=true]{../src/permutation.c}
\clearpage
\section{matorder.c}
\lstinputlisting[breaklines=true]{../src/matorder.c}